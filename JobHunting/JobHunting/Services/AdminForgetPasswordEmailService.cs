...
{
    public class AdminForgetPasswordEmailService
    {
        public string GenerateVerificationToken(string email)
        {
            ...
            //string verificationLink = $"https://duckjobhunting.azurewebsites.net/CompanyVerifyEmail?token={encodedToken}&email={encodedEmail}&expiry={expiry.Ticks}";

            return verificationLink;
        }

        public void SendMail(string receiveMail, string subject)
        {
