...
public partial class DuckAdminsContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdminID).HasName("PK__Admins__719FE4E8BBAA46C7");
        ...
        {
            entity.HasKey(e => e.CandidateID).HasName("PK__Candidat__DF539BFCACE61A31");
        ...
        {
            entity.HasKey(e => e.CompanyID).HasName("PK__Companie__2D971C4CC32228FF");
        ...
        {
            entity.HasKey(e => e.OrderID).HasName("PK__CompanyO__C3905BAFA0E55888");
        ...
        {
            entity.HasKey(e => new { e.CompanyID, e.ResumeID }).HasName("PK__CompanyR__40EA667DE6664A4D");
        ...
        {
            entity.HasKey(e => e.NotificationID).HasName("PK__Notifica__20CF2E324CC4EEDA");
        ...
        {
            entity.HasKey(e => e.OpeningID).HasName("PK__Openings__808F8713EC8ED1DC");
            ...
            entity.HasMany(d => d.Tags).WithMany(p => p.Openings)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("OpeningID", "TagID").HasName("PK__OpeningT__56D848B7184980E7");
        ...
        {
            entity.HasKey(e => e.LetterID).HasName("PK__OpinionL__AE46E8114473E86D");
        ...
        {
            entity.HasKey(e => e.PlanID).HasName("PK__PricingP__755C22D7DD859B9F");
        ...
        {
            entity.HasKey(e => e.ResumeID).HasName("PK__Resumes__D7D7A31782CCB978");
            ...
            entity.HasMany(d => d.Tags).WithMany(p => p.Resumes)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("ResumeID", "TagID").HasName("PK__ResumeTa__01806CB3097A4848");
        ...
        {
            entity.HasKey(e => e.ResumeOpeningRecordID).HasName("PK__ResumeOp__CD5B6F3A68482AAB");
        ...
        {
            entity.HasKey(e => e.TagID).HasName("PK__Tags__657CFA4CC1F11D25");
        ...
        {
            entity.HasKey(e => e.TagClassID).HasName("PK__TagClass__94933B004FDD7526");
        ...
        {
            entity.HasKey(e => e.TitleCategoryID).HasName("PK__TitleCat__079D34D8082A4E17");
        ...
        {
            entity.HasKey(e => e.TitleClassID).HasName("PK__TitleCla__7CC2BED9EF4BBF29");
