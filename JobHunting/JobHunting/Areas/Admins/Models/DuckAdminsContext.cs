...
public partial class DuckAdminsContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdminID).HasName("PK__Admins__719FE4E851F48361");
        ...
        {
            entity.HasKey(e => e.CandidateID).HasName("PK__Candidat__DF539BFC605BFCAF");
        ...
        {
            entity.HasKey(e => e.CompanyID).HasName("PK__Companie__2D971C4CA0099875");
        ...
        {
            entity.HasKey(e => e.OrderID).HasName("PK__CompanyO__C3905BAF0B062546");
        ...
        {
            entity.HasKey(e => new { e.CompanyID, e.ResumeID }).HasName("PK__CompanyR__40EA667D90BF7343");
        ...
        {
            entity.HasKey(e => e.NotificationID).HasName("PK__Notifica__20CF2E32012D644B");
        ...
        {
            entity.HasKey(e => e.OpeningID).HasName("PK__Openings__808F87136A0B4B50");
            ...
            entity.HasMany(d => d.Tags).WithMany(p => p.Openings)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("OpeningID", "TagID").HasName("PK__OpeningT__56D848B74787F5CC");
        ...
        {
            entity.HasKey(e => e.LetterID).HasName("PK__OpinionL__AE46E811135017ED");
        ...
        {
            entity.HasKey(e => e.PlanID).HasName("PK__PricingP__755C22D708A833C6");
        ...
        {
            entity.HasKey(e => e.ResumeID).HasName("PK__Resumes__D7D7A317039A5F3C");
            ...
            entity.HasMany(d => d.Tags).WithMany(p => p.Resumes)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("ResumeID", "TagID").HasName("PK__ResumeTa__01806CB366928C55");
        ...
        {
            entity.HasKey(e => e.ResumeOpeningRecordID).HasName("PK__ResumeOp__CD5B6F3AFA1BDB43");
        ...
        {
            entity.HasKey(e => e.TagID).HasName("PK__Tags__657CFA4CC4BAC75C");
        ...
        {
            entity.HasKey(e => e.TagClassID).HasName("PK__TagClass__94933B00CC5A1FF0");
        ...
        {
            entity.HasKey(e => e.TitleCategoryID).HasName("PK__TitleCat__079D34D8AC866B05");
        ...
        {
            entity.HasKey(e => e.TitleClassID).HasName("PK__TitleCla__7CC2BED91FC7D561");
