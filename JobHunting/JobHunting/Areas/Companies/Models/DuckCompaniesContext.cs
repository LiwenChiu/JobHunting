...
public partial class DuckCompaniesContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__Admins__719FE488510FD0C4");
        ...
        {
            entity.HasKey(e => e.RecordId).HasName("PK__AdminRec__FBDF78E9ECCDC60D");
        ...
        {
            entity.HasKey(e => e.CandidateId).HasName("PK__Candidat__DF539B9CEF59CF8D");
        ...
        {
            entity.HasKey(e => e.CompanyId).HasName("PK__Companie__2D971CAC21B72861");
        ...
        {
            entity.HasKey(e => e.CompanyCategoryId).HasName("PK__CompanyC__0DD4113087480266");
        ...
        {
            entity.HasKey(e => e.CompanyClassId).HasName("PK__CompanyC__2EBC463F46BDBF7E");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__CompanyO__C3905BCF87655752");
        ...
        {
            entity.HasKey(e => new { e.CompanyId, e.ResumeId }).HasName("PK__CompanyR__40EA66A334D49033");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E12A7864B55");
        ...
        {
            entity.HasKey(e => e.OpeningId).HasName("PK__Openings__808F8733A6154D98");
            ...
            entity.HasMany(d => d.Tags).WithMany(p => p.Openings)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("OpeningId", "TagId").HasName("PK__OpeningT__56D848A9B3D41D72");
            ...
            entity.HasMany(d => d.TitleClasses).WithMany(p => p.Openings)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("OpeningId", "TitleClassId").HasName("PK__OpeningT__0743ACD8D108842B");
        ...
        {
            entity.HasKey(e => e.LetterId).HasName("PK__OpinionL__AE46E8F10981FE95");
        ...
        {
            entity.HasKey(e => e.PlanId).HasName("PK__PricingP__755C22B7700D9D72");
        ...
        {
            entity.HasKey(e => e.ResumeId).HasName("PK__Resumes__D7D7A0F7DC21A000");
            ...
            entity.HasMany(d => d.Tags).WithMany(p => p.Resumes)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("ResumeId", "TagId").HasName("PK__ResumeTa__01806F6D19320B8F");
            ...
            entity.HasMany(d => d.TitleClasses).WithMany(p => p.Resumes)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("ResumeId", "TitleClassId").HasName("PK__ResumeTi__501B8B1CE428A750");
        ...
        {
            entity.HasKey(e => e.ResumeOpeningRecordId).HasName("PK__ResumeOp__CD5B6F5A35CE26CB");
        ...
        {
            entity.HasKey(e => e.TagId).HasName("PK__Tags__657CF9AC03A53144");
        ...
        {
            entity.HasKey(e => e.TagClassId).HasName("PK__TagClass__94933B20F6044698");
        ...
        {
            entity.HasKey(e => e.TitleCategoryId).HasName("PK__TitleCat__079D34B869B9C69A");
        ...
        {
            entity.HasKey(e => e.TitleClassId).HasName("PK__TitleCla__7CC2BEB988368672");
