...
public partial class DuckContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdminID).HasName("PK__Admins__719FE4E89610B18B");
        ...
        {
            entity.HasKey(e => e.CandidateID).HasName("PK__Candidat__DF539BFC1A4743EC");
        ...
        {
            entity.HasKey(e => e.CompanyID).HasName("PK__Companie__2D971C4C5077AADB");
        ...
        {
            entity.HasKey(e => e.OrderID).HasName("PK__CompanyO__C3905BAF734BC833");
        ...
        {
            entity.HasKey(e => new { e.CompanyID, e.ResumeID }).HasName("PK__CompanyR__40EA667DF47DF102");
        ...
        {
            entity.HasKey(e => e.NotificationID).HasName("PK__Notifica__20CF2E32AEADE7FD");
        ...
        {
            entity.HasKey(e => e.OpeningID).HasName("PK__Openings__808F871317B68632");
            ...
            entity.HasMany(d => d.Tags).WithMany(p => p.Openings)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("OpeningID", "TagID").HasName("PK__OpeningT__56D848B75354C047");
        ...
        {
            entity.HasKey(e => e.LetterID).HasName("PK__OpinionL__AE46E811F20F9548");
        ...
        {
            entity.HasKey(e => e.PlanID).HasName("PK__PricingP__755C22D7AD9C5CBD");
        ...
        {
            entity.HasKey(e => e.ResumeID).HasName("PK__Resumes__D7D7A317236FF195");
            ...
            entity.HasMany(d => d.Tags).WithMany(p => p.Resumes)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("ResumeID", "TagID").HasName("PK__ResumeTa__01806CB3BDDFD265");
        ...
        {
            entity.HasKey(e => e.ResumeOpeningRecordID).HasName("PK__ResumeOp__CD5B6F3AAC38D17A");
        ...
        {
            entity.HasKey(e => e.TagID).HasName("PK__Tags__657CFA4CD346F8DD");
        ...
        {
            entity.HasKey(e => e.TagClassID).HasName("PK__TagClass__94933B00FDC227F4");
        ...
        {
            entity.HasKey(e => e.TitleCategoryID).HasName("PK__TitleCat__079D34D8B339283E");
        ...
        {
            entity.HasKey(e => e.TitleClassID).HasName("PK__TitleCla__7CC2BED91BCCEB87");
