...
public partial class DuckContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__Admins__719FE4E83553B8B4");
        ...
        {
            entity.HasKey(e => e.CandidateId).HasName("PK__Candidat__DF539BFCE8A266A6");
        ...
        {
            entity.HasKey(e => e.CompanyId).HasName("PK__Companie__2D971C4C8A2D5D5C");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__CompanyO__C3905BAF9305082F");
        ...
        {
            entity.HasKey(e => new { e.CompanyId, e.ResumeId }).HasName("PK__CompanyR__40EA667DFB641F58");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E325E7905C2");
        ...
        {
            entity.HasKey(e => e.OpeningId).HasName("PK__Openings__808F871352805A4B");
            ...
            entity.HasMany(d => d.Tags).WithMany(p => p.Openings)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("OpeningId", "TagId").HasName("PK__OpeningT__56D848B754E74C1B");
        ...
        {
            entity.HasKey(e => e.LetterId).HasName("PK__OpinionL__AE46E8117F28A686");
        ...
        {
            entity.HasKey(e => e.PlanId).HasName("PK__PricingP__755C22D7701165D1");
        ...
        {
            entity.HasKey(e => e.ResumeId).HasName("PK__Resumes__D7D7A317D84535C2");
            ...
            entity.HasMany(d => d.Tags).WithMany(p => p.Resumes)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("ResumeId", "TagId").HasName("PK__ResumeTa__01806CB3FD41FF9D");
        ...
        {
            entity.HasKey(e => e.ResumeOpeningRecordId).HasName("PK__ResumeOp__CD5B6F3AEF7236BA");
        ...
        {
            entity.HasKey(e => e.TagId).HasName("PK__Tags__657CFA4C88DCE22F");
        ...
        {
            entity.HasKey(e => e.TagClassId).HasName("PK__TagClass__94933B004AB924FE");
        ...
        {
            entity.HasKey(e => e.TitleCategoryId).HasName("PK__TitleCat__079D34D8C5FFD5B4");
        ...
        {
            entity.HasKey(e => e.TitleClassId).HasName("PK__TitleCla__7CC2BED9620F54DE");
