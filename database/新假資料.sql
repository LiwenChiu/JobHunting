...
(5, 3, 5, N'客服反饋', N'客服服務評價', N'客服服務態度良好，但回應速度可以更快。', NULL, 1, '2024-09-01 10:00:00'),
(6, 4, 6, N'系統錯誤', N'系統錯誤報告', N'提交簡歷時出現系統錯誤，請儘快修復。', NULL, 1, '2024-07-02 10:00:00'),
(7, NULL, NULL, N'功能請求', N'新功能請求', N'希望在系統中增加一個追蹤應聘進度的功能。', NULL, 0, '2024-05-25 10:00:00'),
(8, 5, 8, N'反饋意見', N'網站功能建議', N'網站功能正常，但希望能增加更多的幫助文檔。', NULL, 1, '2024-04-01 10:00:00'),
(9, 6, 9, N'報告問題', N'報告生成問題', N'報告生成過程中遇到錯誤，請檢查系統。', NULL, 1, '2024-06-01 10:00:00'),
(10, NULL, NULL, N'服務建議', N'服務改進建議', N'建議改進服務響應速度，以提高用戶滿意度。', NULL, 0, '2024-08-04 10:00:00'),
(11, 8, 11, N'意見反饋', N'系統性能反饋', N'系統性能良好，但在高峰期時偶爾會出現延遲。', NULL, 1, '2024-06-29 10:00:00'),
