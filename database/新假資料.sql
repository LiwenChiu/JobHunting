...
(10, 10);
GO
INSERT INTO ResumeOpeningRecords (ResumeId, OpeningId, ApplyDate, InterviewYN, HireYN)
VALUES
(1, 1, '2024-08-15', 1, 0),
(2, 2, '2024-08-16', 0, 0),
(3, 3, '2024-08-17', 1, 1),
...
(1, NULL, 1, N'系統反饋', N'系統故障報告', N'系統在提交簡歷時出現錯誤，請檢查並修復。', NULL, 1),
(2, NULL, NULL, N'功能建議', N'功能改進建議', N'建議增加一個篩選功能以提高搜索效率。', NULL, 0),
(3, NULL, 3, N'帳戶問題', N'帳戶登錄問題', N'無法登錄帳戶，請檢查帳戶設置。', NULL, 1),
(NULL, 2, NULL, N'界面建議', N'界面設計建議', N'希望改進用戶界面，使其更具可用性。', NULL, 0),
(5, 3, 5, N'客服反饋', N'客服服務評價', N'客服服務態度良好，但回應速度可以更快。', NULL, 1),
(6, 4, 6, N'系統錯誤', N'系統錯誤報告', N'提交簡歷時出現系統錯誤，請儘快修復。', NULL, 1),
(7, NULL, NULL, N'功能請求', N'新功能請求', N'希望在系統中增加一個追蹤應聘進度的功能。', NULL, 0),
(8, 5, 8, N'反饋意見', N'網站功能建議', N'網站功能正常，但希望能增加更多的幫助文檔。', NULL, 1),
(9, 6, 9, N'報告問題', N'報告生成問題', N'報告生成過程中遇到錯誤，請檢查系統。', NULL, 1),
(10, NULL, NULL, N'服務建議', N'服務改進建議', N'建議改進服務響應速度，以提高用戶滿意度。', NULL, 0),
(11, 8, 11, N'意見反饋', N'系統性能反饋', N'系統性能良好，但在高峰期時偶爾會出現延遲。', NULL, 1),
(12, NULL, 12, N'安全問題', N'安全漏洞報告', N'發現系統存在安全漏洞，請儘快處理。', NULL, 1),
(NULL, 9, NULL, N'功能請求', N'增加新功能請求', N'希望增加一個自定義報表的功能。', NULL, 0),
(14, NULL, 14, N'網站建議', N'網站改進建議', N'網站界面需要進一步優化以提高用戶體驗。', NULL, 1),
(15, NULL, 15, N'登錄問題', N'登錄問題反饋', N'在某些瀏覽器中無法登錄，請修正。', NULL, 1),
(NULL, 10, NULL, N'系統建議', N'系統功能建議', N'建議在系統中增加多語言支持。', NULL, 0),
(NULL, 1, 17, N'客服問題', N'客服反饋', N'客服回應及時，但解決問題的能力有待提高。', NULL, 1),
(8, NULL, NULL, N'功能建議', N'功能改進建議', N'希望能增加用戶活動記錄功能。', NULL, 0),
(5, NULL, 19, N'報告問題', N'報告生成問題反饋', N'生成報告時出現錯誤，請查明原因並修復。', NULL, 1),
(NULL, 5, NULL, N'系統建議', N'系統優化建議', N'建議進一步優化系統性能，以提高處理速度。', NULL, 0);
